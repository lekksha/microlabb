...
namespace Shops.DAL.Data
{
    public sealed class ShopsDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                ShopContextKey = 1, Id = 1, Category = "одежда", Count = 100, Name = "Трусы", Cost = 123.12m
            }, new ProductContext
            {
                ShopContextKey = 1, Id = 2, Category = "одежда", Count = 100, Name = "Штаны", Cost = 1
            }, new ProductContext
            {
                ShopContextKey = 1, Id = 3, Category = "обувь", Count = 100, Name = "Бутекс", Cost = 2123
            }, new ProductContext
            {
                ShopContextKey = 1, Id = 4, Category = "обувь", Count = 100, Name = "Шлепанцы", Cost = 122
            }, new ProductContext
            {
                ShopContextKey = 2, Id = 5, Category = "обувь", Count = 100, Name = "Ботильоны", Cost = 50
            }, new ProductContext
            {
                ShopContextKey = 2, Id = 6, Category = "еда", Count = 100, Name = "Чебурек", Cost = 50
            }, new ProductContext
            {
                ShopContextKey = 2, Id = 7, Category = "еда", Count = 1002, Name = "Самса", Cost = 50
            }, new ProductContext
            {
                ShopContextKey = 3, Id = 8, Category = "строительные материалы", Count = 100, Name = "Кирпич", Cost = 50
            }, new ProductContext
            {
                ShopContextKey = 3, Id = 9, Category = "строительные материалы", Count = 23, Name = "Асфальт", Cost = 50
            });
        }
    }
}
